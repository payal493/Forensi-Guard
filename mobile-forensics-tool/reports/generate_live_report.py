#!/usr/bin/env python3
"""
Live Case Report Generator for Mobile Forensics Investigation Tool

FORENSIC ROLE:
- Generate comprehensive forensic report for live case
...
def generate_live_case_report(case_id="case_live_001"):
    """
    Generate comprehensive forensic report for live case.
    ...
    report = {
        "report_metadata": {
            ...
            "evidence_source": "Live Android Device (ADB Logical)"
        },
        "case_metadata": {},
        "evidence_integrity": {},
        "timeline_summary": {},
    ...
    # Load hash integrity (may not exist for live case)
    ...
    if os.path.exists(hash_file):
        ...
        report["evidence_integrity"] = {
            "hash_verification_status": "NOT_APPLICABLE",
            "total_files_hashed": 0,
            "hash_algorithm": "N/A",
            "integrity_score": 100.0,
            "note": "Live case with debug artifacts - no hash verification needed"
        }
    ...
    report["conclusions"] = {
        ...
        "next_steps": "Review live debug findings and validate pipeline functionality",
        "note": "This case contains simulated communication artifacts for pipeline validation"
    }
...
def generate_pdf_report(report_data, output_path):
    ...
    try:
        ...
        case_info = [
            ...
            ["Device Type:", report_data["case_metadata"].get("device_model", "Unknown")],
            ["Data Source:", report_data["case_metadata"].get("dataset_source", "Unknown")],
        ...
        if conclusions.get("note"):
            story.append(Paragraph(f"<b>Note:</b> {conclusions['note']}", styles['Normal']))
...
if __name__ == "__main__":
    print("Mobile Forensics - Live Case Report Generator")
    print("=" * 50)
    
    report = generate_live_case_report("case_live_001")
